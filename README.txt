...
3. (Optional) Add a group called eloqua_submit to your CCK content types.  Any fields in this group will also be sumitted to eloqua along with the webform that is submitted from the node's page.
